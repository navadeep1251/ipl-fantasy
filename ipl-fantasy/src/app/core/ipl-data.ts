...
export const TEAM_PLAYERS: Record<string, string[]> = {
  ...
  RR: ['Riyan Parag', 'Yashasvi Jaiswal', 'Dhruv Jurel', 'Shimron Hetmyer', 'Shubham Dubey', 'Ravindra Jadeja', 'Dasun Shanaka', 'Kuldeep Sen', 'Prasidh Krishna', 'Navdeep Saini', 'Nandre Burger', 'Donovan Ferreira', 'Aman Rao Perala', 'Vaibhav Suryavanshi', 'Ravi Singh', 'Lhuan-dre Pretorius', 'Jofra Archer', 'Tushar Deshpande', 'Kwena Maphaka', 'Sandeep Sharma', 'Vignesh Puthur', 'Brijesh Sharma', 'Sushant Mishra', 'Yash Raj Punja', 'Adam Milne', 'Ravi Bishnoi'],
  SRH: ['Liam Livingstone', 'Harshal Patel', 'Pat Cummins','Dilshan Madhushanka', 'Ishan Kishan', 'Travis Head', 'Heinrich Klaasen', 'Abhishek Sharma', 'Nitish Kumar Reddy', 'Jaydev Unadkat', 'David Payne', 'Aniket Verma', 'Smaran Ravichandran', 'Kamindu Mendis', 'Harsh Dubey', 'Shivang Kumar', 'Salil Arora', 'Brydon Carse', 'Eshan Malinga', 'Zeeshan Ansari', 'Sakib Hussain', 'Onkar Tarmale', 'Amit Kumar', 'Praful Hinge', 'Shivam Mavi'],
};
...
export function getDefaultPlayerPassword(username: string): string {
  return DEFAULT_PLAYER_PASSWORDS[normalizeFantasyUsername(username)] ?? 'ipl2026';
}
